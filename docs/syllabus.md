...
Software is rarely built by a single person working alone &mdash; it's built by teams, over time, under changing requirements. This course is about that reality. Each team will spend the semester contributing to a real, established open-source project, practicing modern software engineering: requirements analysis, design, implementation, testing, code review, continuous integration, release management, project management, and team coordination. The project will incorporate agentic AI assistants to support project evolution.
...
- **Course site:** [csci-435-se.github.io](https://csci-435-se.github.io/) &mdash; schedule, syllabus, slides, etc.
- **GitHub organization:** [github.com/CSCI-435-SE](https://github.com/CSCI-435-SE) &mdash; team repositories
- **Blackboard:** [blackboard.wm.edu](https://blackboard.wm.edu/) &mdash; grades, announcements
- **Course communication:** [Zulip](https://zulip.com/) &mdash; course Q&A, team discussion, etc.

## 7. Schedule and important dates

The full schedule (topics, sprints, and all key dates) is maintained on the [Schedule](schedule.md) page and is subject to change.
...
- Nov 5 &mdash; New-tech showcase, round 2
- Nov 17 & 19 &mdash; TA-led in-class working sessions (instructor away)
- **Nov 25&ndash;29 &mdash; Thanksgiving Break, no class**
- Dec 1 & 3 &mdash; Final project presentations
- **Dec 4 &mdash; Last day of classes**
- **Dec 9 &mdash; Final exam, 9:00 AM&ndash;12:00 PM**
- Dec 15 &mdash; Project due
...
- Project development (sprints): 55%
    - Sprint 0 &mdash; team/project setup & system learning: 9%
    - Sprint 1 &mdash; project development & release: 10%
    - Sprint 2 &mdash; project development & release: 12%
    - Sprint 3 &mdash; project development & release: 12%
    - Sprint 4 / Final &mdash; project development & release: 12%
- **Total: 100%**
...
|---|---|---|---|
| A | S &ge; 95 | C+ | 77 &le; S < 80 |
| A- | 90 &le; S < 95 | C | 73 &le; S < 77 |
| B+ | 87 &le; S < 90 | C- | 70 &le; S < 73 |
| B | 83 &le; S < 87 | D+ | 67 &le; S < 70 |
| B- | 80 &le; S < 83 | D | 63 &le; S < 67 |
| | | D- | 60 &le; S < 63 |
| | | F | S < 60 |

## 9. Project structure: sprints, presentations, and showcases
...
The course has a final exam (Dec 9, 9:00 AM&ndash;12:00 PM), covering all topics from the semester. Exams are closed book/notes/electronics unless stated otherwise.
...
## 11. Late policy, attendance, and communication

Students are expected to submit coursework on time and attend lectures. While attendance is not directly controlled, it is for your benefit &mdash; in the past, students who missed classes have had more trouble completing assignments and exams.
...
## 13. Academic integrity and team collaboration
...
- Every team member is expected to contribute directly to the project throughout the semester &mdash; writing code, reviewing changes, working issues, etc. &mdash; not simply rely on teammates to carry the work.
...
## 14. Policy on the use of AI tools (AI ledger)
...
- You are accountable for verifying all AI-generated output. AI tools can fabricate or misattribute information &mdash; errors in your submission remain your responsibility.
- "Prompt &rarr; copy &rarr; paste" without meaningful review, modification, or attribution violates the Honor Code.

## 15. Academic support and accommodations
...
- For academic support such as tutoring, time management, study skills, and academic coaching, contact Academic Wellbeing at [wm.edu/academicwellbeing](https://www.wm.edu/academicwellbeing) ([academicwellbeing@wm.edu](mailto:academicwellbeing@wm.edu)).
- William & Mary accommodates students with disabilities and qualifying diagnosed conditions following federal and state laws. Any student who needs an accommodation should contact Student Accessibility Services at (757) 221-2512 or [sas@wm.edu](mailto:sas@wm.edu).
...
- Care Support Services at [wm.edu/care](https://www.wm.edu/care) ([care@wm.edu](mailto:care@wm.edu)), for interpersonal, academic, and wellness concerns.
